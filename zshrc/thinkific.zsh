...
function genvpn {
    ...
    scp -i "$HOME/.aws/thinkific-$1-us-east-1.pem" "$CONNECTION:$2.ovpn" .;
    echo "Renaming OVPN filename to reflect $1 environment...";
    mv $2.ovpn $2-$1.ovpn;
    echo "mv $2.ovpn $2-$1.ovpn";
}
